            ...
            <div class="menu-sidebar2__content js-scrollbar1">
                ...
                <nav class="navbar-sidebar2">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="../My Dashboard Projects Form/Dashboard.aspx">
             ...
             <div class="table-responsive table--no-card m-b-40" style=" height:500px;">
                 <asp:GridView ID="GridView1" CssClass="table table-borderless table-condensed table-striped table-earning table-sm" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged1">
                     <Columns>
                         ...
                         <asp:BoundField DataField="Comment" HeaderText="نظر" SortExpression="Comment" />
                         <asp:BoundField DataField="PuOrPr" HeaderText="نوع" SortExpression="PuOrPr" />
                 ...
                 <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:WebProjectConnectionString %>" SelectCommand="SELECT * FROM [CommentsTeble]"></asp:SqlDataSource>
              ...
              <div>
                  ...
                  Comment :
                  <asp:TextBox ID="CommentText" runat="server"></asp:TextBox><br/>
                  Type :
                  <asp:TextBox ID="TypeText" runat="server"></asp:TextBox><br/>
                  Date :
                  <asp:TextBox ID="DateText" runat="server"></asp:TextBox><br/>
                  UserName :
                  <asp:TextBox ID="UserNameText" runat="server"></asp:TextBox><br/>                  
              </div>
