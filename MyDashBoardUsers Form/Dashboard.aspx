        ...
        <div class="page-container2">
          ...
          <div style="margin:100px auto; background-color:white;" >
             ...
             <div class="table-responsive table--no-card m-b-40" style=" height:500px;">
                <asp:GridView ID="GridView1" CssClass="table table-borderless table-condensed table-striped table-earning table-sm" Height="100px" Width="100px" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                    <Columns>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:WebProjectConnectionString %>" SelectCommand="SELECT * FROM [User]"></asp:SqlDataSource>
             </div>

              <div>
                  ID :
                  <asp:TextBox ID="TextID" runat="server"></asp:TextBox><br/>
                  Name And Family :
                  ...
                  Tel :
                  <asp:TextBox ID="TextTel" runat="server"></asp:TextBox><br/>
                  Password :
